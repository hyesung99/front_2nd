...
import { useAddProductButtonProps } from "../../refactoring/hooks/useAddProductButtonProps";
import { CartProvider } from "../../refactoring/store/cartContext";
...
describe("advanced > ", () => {
  ...
  describe("자유롭게 작성해보세요.", () => {
    ...
    test("새로운 hook 함수를 만든 후에 테스트 코드를 작성해서 실행해보세요", () => {
      describe("useAddProductButtonProps 테스트", () => {
        test("재고가 있을 때 올바른 버튼 속성을 반환해야 합니다", () => {
          const { result } = renderHook(() => useAddProductButtonProps(5), {
            wrapper: TestWrapper,
          });
        ...
        test("재고가 없을 때 올바른 버튼 속성을 반환해야 합니다", () => {
          const { result } = renderHook(() => useAddProductButtonProps(0), {
            wrapper: TestWrapper,
          });
        ...
        test("재고가 음수일 때도 품절 상태를 반환해야 합니다", () => {
          const { result } = renderHook(() => useAddProductButtonProps(-1), {
            wrapper: TestWrapper,
          });
